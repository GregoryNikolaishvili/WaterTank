...
// 	interval(interval_millis_rise, interval_millis_fall);
// 	previous_millis = millis();

// 	state = digitalRead(pin) ^ isInverted;
// }

// void Bounce::write(int new_state)
// {
// 	this->state = new_state;
// 	digitalWrite(pin, state ^ isInverted);
// }

// void Bounce::interval(unsigned long interval_millis_rise, unsigned long interval_millis_fall)
// {
// 	this->interval_millis_rise = interval_millis_rise;
// 	this->interval_millis_fall = interval_millis_fall;
...
// int Bounce::debounce()
// {
// 	uint8_t newState = digitalRead(pin) ^ isInverted;
// 	if (state != newState)
// 	{
// 		if (millis() - previous_millis >= (newState ? interval_millis_rise : interval_millis_fall))
// 		{
// 			previous_millis = millis();
// 			state = newState;
// 			return 1;
